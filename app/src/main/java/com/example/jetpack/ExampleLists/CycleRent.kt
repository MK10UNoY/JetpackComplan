...
import com.example.jetpack.ExampleLists.Data.getCycleList
import com.example.jetpack.Navigation.cycleDetails
import com.example.jetpack.R

@OptIn(ExperimentalMaterial3Api::class)

@Composable
fun CycleRent(navController: NavController) {
            ...
            LazyColumn {
                items(getCycleList()) { item ->
                    Block1(
                        ...
                        navController.navigate(cycleDetails)
                    }
...
@Composable
fun Block1(img: Int, name: String, schid: String, price: String, onClick:() -> Unit) {
    Card(
        modifier = Modifier
            .padding(8.dp)
            .background(Color(717070)).clickable { onClick() }
